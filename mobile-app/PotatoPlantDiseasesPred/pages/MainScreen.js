...
const MainScreen = () => {
    ...
    const predict = async () => {
      ...
      const formData = new FormData()
            ...
            let res = await fetch('http://43.204.148.134/predict', {
              method: 'post',
              body: formData,
              headers: {
  ...
  return (
    ...
    <View style={styles.header}>
        <Text style={styles.headerText}>Potato Leaf Disease</Text>
...

    {
      ...
      (<Text style={styles.instrText}>Upload or Capture a Potato Leaf Image Using the Buttons Below</Text>)
    }
